...
class Files:
    ...
    def craeteForlderAndCopy(self, name_folder: str = None, path : str = None, file: str = None, destiny: str = None) -> None:
        self.__nameFolder = name_folder

        if not exists(name_folder):
            makedirs(self.__nameFolder, exist_ok=True)
    ...
    def rename_one_file(self, path, nameOld, nameNow):
       if exists(path):
          rename(nameOld, nameNow)
    ...
    def adjust_bar(self, path: str = None, path_destiny: str = None, old_replace: str = None, new_replace: str = None):
        self._list = []
        ...
        with open_dcs(path, 'r+', encoding='utf-8') as f:
            ...
            self._content = self._list.append(self._content.replace(f'{old_replace}', f'{new_replace}'))
